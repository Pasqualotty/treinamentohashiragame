...
**Atualizado:** 2026-09-12 (mapa/1v1: amigo joga na sala; dummy só no F6) 
...
| Elenco 15 (Tanjiro starter; Nezuko livre; resto por `stage_id`) | ✅ |
...
| Amigos / sala | ✅ Wi-Fi **ou** outra casa; 2 ou 4 vs oni; mapa/1v1 = 2P (amigo joga); clube/notícias/eventos ainda fora |
...
| Elenco | `CharacterCatalog` 15 ids; save `unlocked_characters` + `current_character_id` |
